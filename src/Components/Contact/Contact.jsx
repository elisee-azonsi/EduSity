        ...
        <p>Feel free to reach out through contact form or 
            ...
            and suggestions are important to us as we strive to
             ...
             <ul>
                ...
                <li><img src={location_icon} alt="" />1 Street of Love, Manhattan <br />United States of Americ</li>
             </ul>
      </div>
      <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            <label>Phone Nulber</label>
            <input type="text" name='phone' placeholder='Enter your mobile number' required />
            <label>Write your messages here</label>
            <textarea type="text" name='message' rows="6"  placeholder='Enter your name' required>
            </textarea>
